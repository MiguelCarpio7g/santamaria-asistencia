...
echo '<script language="javascript">alert("Fecha inicial vacia");window.location.href="usuarios.php"</script>';
  ...
  // 	header('Location: ventas.php' );
	...
	//Consulta
	$sql = "SELECT * FROM  tbl_registrodeasistencia INNER JOIN tbl_empleados
	 ON tbl_empleados.ced_empleado = tbl_registrodeasistencia.ced_empleado  WHERE  tbl_registrodeasistencia.ced_empleado='$cedula1'  and tbl_registrodeasistencia.fecha_empleados BETWEEN '$fecha1' AND '$fecha2' ";
	...
	$objPHPExcel->getActiveSheet()->setCellValue('C3', 'REPORTE DE ASISTENCIA DE EMPLEADO');
