...
while ($row=mysqli_fetch_array($sql))
	...
	$insert_detail=mysqli_query($con, "INSERT INTO tbldetalle_compra (numero_com, codigo_ani, cantidad, precio_com) VALUES ('$numero_factura','$codigo_producto','$cantidad','$precio_venta_r')");
...
//---------------------------------------------------------------
$insert=mysqli_query($con,"INSERT INTO tbl_compras VALUES ('$numero_factura','$date','$id_cliente','$cedula_usu','$condiciones','$total_factura','$estado','0',
'$factura','$fecha_inicial_cuota','$fecha_fin_cuota','$fecha_ingreso_factura','$iva','$meses_cuota_com')");
...
//----------------------------------------------------------------
if($condiciones=='4'){
$insert2=mysqli_query($con,"INSERT INTO tbl_cuotas (numero_com_cuo, condiciones_com_cuo, cedula_pro, fecha_cuo,
