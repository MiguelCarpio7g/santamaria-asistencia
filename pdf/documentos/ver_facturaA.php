<?php
	...
	$estado_factura=$rw_factura['estado_ven'];
		$fecha_inicial_cuota=$rw_factura['fecha_inicio_ven'];
			$fecha_fin_cuota=$rw_factura['fecha_fin_ven'];
			$meses_cuota_ven=$rw_factura['meses_cuota_ven'];

	require_once(dirname(__FILE__).'/../html2pdf.class.php');
    // get the HTML
     ob_start();
     include(dirname('__FILE__').'/res/ver_factura_htmlA.php');
