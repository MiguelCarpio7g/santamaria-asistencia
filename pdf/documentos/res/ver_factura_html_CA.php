...
$nums=1;
$sumador_total=0;
$sql=mysqli_query($con, "select * from tbl_animales, tbldetalle_compra, tbl_compras where tbl_animales.codigo_ani=tbldetalle_compra.codigo_ani and tbldetalle_compra.numero_com=tbl_compras.numero_com and tbl_compras.numero_com='".$id_factura."'");
