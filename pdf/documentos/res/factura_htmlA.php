...
$ruc=$row['ruc'];
			...
			Factura Nº <?php echo $numero_factura_formateado;?>
			</td>
	...
	$meses_cuota_ven =mysqli_real_escape_string($con,(strip_tags($_REQUEST['meses_cuota_ven'])));
		echo "  ";
		echo 	$meses_cuota_ven;
...
$nums=1;
$sumador_total=0;
$sql=mysqli_query($con, "select * from tbl_animales, tbl_tmp where tbl_animales.codigo_ani=tbl_tmp.codigo_ani and tbl_tmp.session_id='".$session_id."'");
while ($row=mysqli_fetch_array($sql))
	{
	$id_tmp=$row["id_tmp"];
	//$id_producto=$row["id_producto"];
	$codigo_producto=$row['codigo_ani'];
	$cantidad=$row['cantidad_tmp'];
	$nombre_producto=$row['nombre_ani'];
	...
	$insert_detail=mysqli_query($con, "INSERT INTO tbldetalle_venta (numero_ven, codigo_ani, cantidad, precio_ven) VALUES


		 ('$numero_factura_formateado','$codigo_producto','$cantidad','$precio_venta_r')");
...
$fecha_fin_cuota=mysqli_real_escape_string($con,(strip_tags($_REQUEST['fecha_fin_cuota'])));
	...
	//$meses_cuota_ven =($_POST['meses_cuota_ven']);



$insert=mysqli_query($con,"INSERT INTO tbl_ventas VALUES ('$numero_factura_formateado','$date','$id_cliente','$id_vendedor','$condiciones','$total_factura','$estado','3',
'$fecha_inicial_cuota','$fecha_fin_cuota','$meses_cuota_ven','','','','$iva')");
...
//----------------------------------------------------------------
if($condiciones=='4'){
$insert_cuot=mysqli_query($con,"INSERT INTO tbl_cuotas (numero_ven_cuo, condiciones_ven_cuo, cedula_cli, fecha_cuo,
status_cuo, deuda_cuo, tipo_cuo, fechai_cuo, fechaf_cuo) VALUES
('$numero_factura_formateado','$condiciones','$id_cliente','$date','2','$total_factura','0','$fecha_inicial_cuota','$fecha_fin_cuota')");
