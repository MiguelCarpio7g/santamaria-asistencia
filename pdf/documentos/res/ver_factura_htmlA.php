...
$nums=1;
$sumador_total=0;
$sql=mysqli_query($con, "select * from tbl_animales, tbldetalle_venta, tbl_ventas where tbl_animales.codigo_ani=tbldetalle_venta.codigo_ani and tbldetalle_venta.numero_ven=tbl_ventas.numero_ven and tbl_ventas.numero_ven='".$id_factura."'");
...
//	$id_producto=$row["codigo_prod"];
	...
	$total_iva=($subtotal * $iva_ven )/100;
...
?>
		...
		<tr>
            <td colspan="3" style="widtd: 85%; text-align: right;">IVA (<?php echo $iva_ven; ?>)% &#36; </td>
