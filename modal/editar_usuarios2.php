    ...
    <!---------->
		<!---------->
			 ...
			 <div class="col-sm-8">
				 ...
				 minlength="10" maxlength="10"  required pattern="[0-9]{10}" name="mod_cedula" onkeypress="return validaNumericos(event)" autocomplete="off"  readonly>
			 </div>
			 </div>
		 <!---------->
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
				  ...
				  <input type="hidden" id="mod_id" name="mod_id" autocomplete="off">
				</div>
			  </div>
				 <!---------->
			  <div class="form-group">
