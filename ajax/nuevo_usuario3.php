    ...
    require_once("../libraries/password_compatibility_library.php");
        ...
        $rol=mysqli_real_escape_string($con,(strip_tags($_POST["rol_usu"],ENT_QUOTES)));
                ...
                if ($query_check_user == 1) {
                    ...
                    $sql = "INSERT INTO tbl_empleados (ced_empleado, nombre_empleado, apellido_empleado, telefono_empleado, email_empleado, direccion_empleado, status_empleado, password_empleado, rol_empleado, fecha_empleado)
                            VALUES('".$cedula."','".$nombre."','".$apellido."','" . $telefono . "', '" . $user_email . "', '" . $direccion . "','".$status."', '".$user_password_hash."', '".$rol."', '".$date_added."');";
                    $query_new_user_insert = mysqli_query($con,$sql);

                    // si el usuario ha sido agregado exitosamente
                    if ($query_new_user_insert) {
                        //$messages[] = "el usuario ha sido creada con éxito.";
                      echo '<script language="javascript">alert("Datos del usuario ingresados");window.location.href="usuarios3.php"</script>';
