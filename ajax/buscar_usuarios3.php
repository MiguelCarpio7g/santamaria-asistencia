...
if ($action == 'ajax') {
    ...
    $sWhere = "where ced_empleado=ced_empleado "; // Filtrar por usuario logueado
    
    if ($_GET['q'] != "") {
        $sWhere .= " AND (ced_empleado LIKE '%$q%' OR ced_empleado LIKE '%$q%')";
    }
    
    $sWhere .= " ORDER BY fecha_empleado DESC";
...
$fullname = $first_name . " " . $first_last_name;
                    ...
                    $fecha_empleado = $row['fecha_empleado'];
                    ?>
