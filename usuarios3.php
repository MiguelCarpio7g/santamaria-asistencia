...
<br><br>
			...
			<?php
			include("modal/registro_usuarios3.php");
			include("modal/editar_usuarios3.php");
			include("modal/cambiar_password3.php");

			
			?>

			<!--buscar por fecha-->
			<form method="post" class="form"  action="./reporte_empl3.php">
	...
	<div class="panel-heading">
	<div class="btn-group pull-right">
		<a  href="usuarios3.php" class="btn btn-info"><span class="glyphicon glyphicon-refresh"></span> Refrescar pagina</a>
	</div>	</div>
	...
	include("footer.php");
	?>
	<script type="text/javascript" src="js/usuarios3.js"></script>
